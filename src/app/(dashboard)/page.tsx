    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatsCard
          ...
          value={`${stats.unpaidInvoices} (${formatCurrency(stats.unpaidTotal)})`}
          icon={
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
        ...
        <CardContent>
          {recentActivity.length === 0 ? (
            <p className="text-secondary-light text-center py-8">
              No recent activity. Create your first estimate to get started!
            </p>
          ) : (
                  ...
                  <div className="flex items-center gap-4">
                    <div
                      className={`
                        ...
                        ${activity.type === 'estimate' ? 'bg-info/10 text-info' : ''}
                        ${activity.type === 'job' ? 'bg-warning/10 text-yellow-600' : ''}
                      `}
                    >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-secondary-light">
                        {activity.customerName} &bull; {formatCurrency(activity.amount)}
                      </p>
                    </div>
                  </div>
